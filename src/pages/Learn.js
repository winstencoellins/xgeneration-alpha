...
const listWorkshop = [
  ...
  {
    id:"4",
    name: "Design Principle with Photoshop and Illustrator",
    type: "Graphic Design",
    image: "https://images.unsplash.com/photo-1613479205646-c0dc1ee8511f?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
    description: "Mencurahkan ide kreatif kamu menjadi kenyataan dengan Adobe Photoshop dan Adobe Illustrator, merupakan software graphic design yang paling sering digunakan pada industri saat ini. Kamu akan diajarkan cara penggunaan kedua software tersebut yang dibarengi langsung dengan real-world practice. Kamu juga akan belajar membuat digital graphic yang sesuai dengan kaidah-kaidah marketing dan lainnya.",
    link: "http://bit.ly/chigendesign1",
  },
]
...
function Learn() {
  return (
    <>
      <Helmet>
        <title>Learn | Chi-Generation</title>
        <meta name="description" content="List Coding Workshop yang akan kami laksanakan selanjutnya." />
      </Helmet>
      <main id="main" className="mt-32 mb-10">
